        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data"
            ...
            <div class="form-group">
                ...
                <select class="form-control mt-2" id="country" onchange="updateForm()">
                    ...
                    <option value="country">New Zealnd</option>
                </select>
            </div>
            <div class="form-group">
                ...
                <select class="form-control mt-2" id="state" onchange="updateForm()">
                    ...
                    <option value="country">Rajasthan</option>
                    <option value="country">Bihar</option>
                </select>
            </div>
            <div class="form-group">
                ...
                <select class="form-control mt-2" id="city" onchange="updateForm()">
                    ...
                    <option value="country">Bhopal</option>
                    <option value="country">Ujjain</option>
                </select>
            </div>
            <div class="form-group">
